...
class Price_compare:
    ...
    def price_amzn(self, key):
        ...
        for html in self.soup.find_all('div', {'class':'sg-col-4-of-12 sg-col-8-of-16 sg-col-12-of-20 sg-col'}):
            title, price, link = None, 'CHECK WEBSITE  ---->', None
            for heading in html.find_all('span', {'a-size-medium a-color-base a-text-normal'}):
                title = heading.text
